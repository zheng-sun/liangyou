  ...
  <div class="block4 container-900 mg-auto overflow clearfix">
      ...
      <div class="right">
          <div class="links links1">
              ...
              <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=34151e12c94c772aed01188348b4e4c0&action=position&posid=18&order=listorder+DESC&num=2\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'18','order'=>'listorder DESC','limit'=>'2',));}?> 
              <ul class="clearfix">
                <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
